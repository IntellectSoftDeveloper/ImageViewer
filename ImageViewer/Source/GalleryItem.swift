...
public typealias ItemViewControllerBlock = (_ index: Int, _ itemCount: Int, @escaping _ fetchImageBlock: FetchImageBlock, _ configuration: GalleryConfiguration, _ isInitialController: Bool) -> UIViewController
